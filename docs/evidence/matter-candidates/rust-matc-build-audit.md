...
The candidate repository's `src` tree contains 3,304,384 Rust bytes and 180,093
other code bytes, or 94.83% Rust by this deliberately broad repository metric.
...
Cross-platform build and packaging feasibility passes for the pinned source.
The compiled default path satisfies the Rust-majority and first-party unsafe/FFI
target. This does not yet pass the complete ADR-0038 candidate gate: independent
commission/read/invoke/subscribe/restart/remove evidence, secret-store fit,
cancellation, partial outcomes, and SDK-neutral adapter mapping belong to
E4-008-03. Candidate self-tests cannot substitute for that evidence.
